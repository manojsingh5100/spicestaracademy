TableFilter = function RejectedCandidateFilter(selector, filterIndex) {
    if (selector === "tblReport")
        ...
        if (selector === "tblRejectRegistration")
            $('#' + selector + '_filter').prepend("<select onclick='filterWithdrawalCandidate(this)' style='height:32px;width:175px;'><option value=''>Withdrawal Candidates</option><option value='All'>All Candidates</option></select>  &nbsp;<select onclick='coursefilter(this," + filterIndex + ")' style='height:32px;width:125px;'><option value=''>Select Course</option><option value='BBA'>BBA</option><option value='MBA'>MBA</option><option value='PHT'>PHT</option></select>&nbsp;&nbsp;&nbsp;&nbsp;");
        else {
            if (selector === "tblScreening") {
                ...
                if (selector == "tblMedical") {
                    $('#' + selector + '_filter').prepend("<select onchange='coursefilter(this," + filterIndex + ")' style='height:32px;width:125px;'><option value=''>Select Course</option><option value='BBA'>BBA</option><option value='MBA'>MBA</option><option value='PHT'>PHT</option></select>&nbsp;&nbsp;<select onchange='screenningbatchfilter(this,8)' style='height:32px;width:125px;margin-right: 0px;' id='ddlbatchfilter'><option value=''>Select Batch</option></select>&nbsp;&nbsp;");
                } else {
                    $('#' + selector + '_filter').prepend("<select onchange='coursefilter(this," + filterIndex + ")' style='height:32px;width:125px;'><option value=''>Select Course</option><option value='BBA'>BBA</option><option value='MBA'>MBA</option><option value='PHT'>PHT</option></select>&nbsp;&nbsp;&nbsp;&nbsp;");
                }
                if (selector == "tblAddmissionView") {
                    $('#' + selector + '_filter').prepend("<select onchange='trfilter(this)' style='height:32px;width:155px;'><option value=''>All Candidates</option><option value='Termination'>Terminated Candidates</option><option value='Resignation'>Resigned Candidates</option></select>&nbsp;&nbsp;<select onchange='screenningbatchfilter(this,8)' style='height:32px;width:125px;margin-right: 0px;' id='ddlbatchfilter'><option value=''>Select Batch</option></select>&nbsp;&nbsp;");
                }
            }
        }
        if (selector === "tblFeeCandidatesList") { $('#' + selector + '_filter').prepend("<select onclick='feeStatusFilter(this,11)' style='height:32px;width:125px;margin-right: 13px;'><option value=''>Select Fee Status</option><option value='Due'>Due</option><option value='Deposited'>Deposited</option></select>&nbsp;&nbsp;<select onchange='screenningbatchfilter(this,8)' style='height:32px;width:125px;margin-right: 0px;' id='ddlbatchfilter'><option value=''>Select Batch</option></select>&nbsp;&nbsp;"); }
    }
};
